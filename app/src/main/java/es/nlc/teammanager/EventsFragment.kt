...
class EventsFragment : Fragment(), View.OnClickListener {
    ...
    private fun setUpRecyclerView() {
        val products = mutableListOf<events>(
            ...
            events(getString(R.string.entrene), "21/11" , "20:30", "22:00", 12, 5, 3),
            events(getString(R.string.entrene), "23/11" , "20:30", "22:00", 16, 2, 2 ),
            events(getString(R.string.partit), "26/11" , "19:00", "20:45", 16, 3, 1 ),
            events(getString(R.string.entrene), "28/11" , "20:30", "22:00", 15, 2, 3),
            events(getString(R.string.entrene), "30/11" , "20:30", "22:00", 17, 2, 1 ),
            events(getString(R.string.partit), "03/12" , "17:30", "19:15", 16, 3, 1 ),
            events(getString(R.string.entrene), "05/12" , "20:30", "22:00", 15, 2, 3),
            events(getString(R.string.entrene), "14/12" , "20:30", "22:00", 17, 2, 1 ),
            events(getString(R.string.partit), "17/12" , "19:00", "20:45", 16, 3, 1 ),
            events(getString(R.string.entrene), "19/12" , "20:30", "22:00", 15, 2, 3),
            events(getString(R.string.entrene), "21/12" , "20:30", "22:00", 17, 2, 1 ),
            events(getString(R.string.partit), "14/01" , "17:30", "19:15", 16, 3, 1 ),
            events(getString(R.string.entrene), "16/01" , "20:30", "22:00", 15, 2, 3),
            events(getString(R.string.entrene), "18/01" , "20:30", "22:00", 17, 2, 1 ),
            events(getString(R.string.partit), "21/01" , "19:00", "20:45", 16, 3, 1 ),
        )
